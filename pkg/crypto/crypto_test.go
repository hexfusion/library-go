...
func TestWhitelistEtcdCipherSuites(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			wantWhitelist:    []string{},
			wantUnsupported: []string{
				"TLS_AES_128_GCM_SHA256", // https://ciphersuite.info/cs/TLS_AES_128_GCM_SHA256/
				"TLS_AES_256_GCM_SHA384", // https://ciphersuite.info/cs/TLS_AES_256_GCM_SHA384/
				"TLS_CHACHA20_POLY1305_SHA256", // https://ciphersuite.info/cs/TLS_CHACHA20_POLY1305_SHA256/
				"ECDHE-ECDSA-AES128-GCM-SHA256", // https://ciphersuite.info/cs/TLS_ECDHE_ECDSA_WITH_AES_128_GCM_SHA256/
				"ECDHE-RSA-AES128-GCM-SHA256", // https://ciphersuite.info/cs/TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256/
 				"ECDHE-ECDSA-AES256-GCM-SHA384", // https://ciphersuite.info/cs/TLS_ECDHE_ECDSA_WITH_AES_256_GCM_SHA384/
				"ECDHE-RSA-AES256-GCM-SHA384", // https://ciphersuite.info/cs/TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384/
				"ECDHE-ECDSA-CHACHA20-POLY1305", // https://ciphersuite.info/cs/TLS_ECDHE_ECDSA_WITH_CHACHA20_POLY1305_SHA256/
				"ECDHE-RSA-CHACHA20-POLY1305", // https://ciphersuite.info/cs/TLS_ECDHE_RSA_WITH_CHACHA20_POLY1305_SHA256/
				"DHE-RSA-AES128-GCM-SHA256", // https://ciphersuite.info/cs/TLS_DHE_RSA_WITH_AES_128_GCM_SHA256/
				"DHE-RSA-AES256-GCM-SHA384", // https://ciphersuite.info/cs/TLS_DHE_RSA_WITH_AES_256_GCM_SHA384/
			},
		},
		{
			...
			wantWhitelist: []string{
				// TLS_ECDHE_ECDSA_WITH_CHACHA20_POLY1305_SHA256, valid go 1.14+ etcd is 1.12 (v3.4)
				// TLS_ECDHE_RSA_WITH_CHACHA20_POLY1305_SHA256, valid go 1.14+ etcd is 1.12 (v3.4)
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			gotWhitelist, gotUnsupported := WhitelistEtcdCipherSuites(test.ciphers)
			if !reflect.DeepEqual(test.wantWhitelist, gotWhitelist) {
				t.Errorf("wantWhitelist %v got %v", test.wantWhitelist, gotWhitelist)
			}
			if !reflect.DeepEqual(test.wantUnsupported, gotUnsupported) {
				t.Errorf("wantUnsupported %v got %v", test.wantUnsupported, gotUnsupported)
			}
		})
	}
